<%@ Page Language="C#" AutoEventWireup="true" CodeFile="html_PackFiles.aspx.cs" Inherits="html_PackFiles" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="modal-body">
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th><%=this.GetLocalResourceObject("title_檔名").ToString()%></th>
                        <th><%=this.GetLocalResourceObject("title_下載").ToString()%></th>
                    </tr>
                </thead>
                <tbody>
                    <asp:ListView ID="lvDataList" runat="server" ItemPlaceholderID="ph_Items" OnItemDataBound="lvDataList_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr>
                                <th scope="row"><%#Eval("Pic_OrgFile") %></th>

                                <td>
                                    <asp:Literal ID="lt_Files" runat="server"></asp:Literal>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:ListView>
