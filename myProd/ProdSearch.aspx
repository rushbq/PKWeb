<%@ Page Title="Products" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ProdSearch.aspx.cs" Inherits="myProd_ProdList" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container df-container-margin">
        ...
        <ul class="nav nav-tabs">
            <li role="presentation" class="active"><a href="#"><%=Resources.resPublic.title_工具專區 %></a></li>
            <li role="presentation">
                <a href="<%=Application["WebUrl"] %>Search/RobotKit/?k=<%:Req_Keyword %>"><%=Resources.resPublic.title_科學玩具 %>
                    <span class="badge">
                        <asp:Literal ID="lt_ToyCnt" runat="server"></asp:Literal></span>
                </a>
            </li>
        </ul>
