<%@ WebHandler Language="C#" Class="GetData_ProdCert" %>
...
public class GetData_ProdCert : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        using (SqlCommand cmd = new SqlCommand())
        {
            using (SqlCommand cmdTotalCnt = new SqlCommand())
            {
                ...
                SBSql.Append("     AND (Prod.Model_No IN (");
                SBSql.Append("        SELECT Base.Model_No");
                SBSql.Append("        FROM [ProductCenter].dbo.Prod_Certification Base WITH (NOLOCK)");
                SBSql.Append("         INNER JOIN [ProductCenter].dbo.Prod_Certification_Detail Dtl WITH (NOLOCK) ON Base.Cert_ID = Dtl.Cert_ID");
                SBSql.Append("        WHERE (Dtl.IsWebDW = 'Y')");
                SBSql.Append("     ))");
