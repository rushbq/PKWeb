<%@ Page Title="RobotKits" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ProdSearch.aspx.cs" Inherits="myToyProd_ProdList" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="Server">
    <div class="container df-container-margin">
        ...
        <asp:Panel ID="pl_blank" runat="server" Style="height: 30px;" Visible="false"></asp:Panel>
        <!-- Content Start -->
        <ul class="nav nav-tabs">
            <li role="presentation">
                <a href="<%=Application["WebUrl"] %>Search/Tool/?k=<%:Req_Keyword %>"><%=Resources.resPublic.title_工具專區 %>
                    <span class="badge">
                        <asp:Literal ID="lt_ToolCnt" runat="server"></asp:Literal></span>
                </a>
            </li>
            <li role="presentation" class="active"><a href="#"><%=Resources.resPublic.title_科學玩具 %></a></li>
        </ul>
